...
public class Mp3FilenameFormatAction extends FilenameFormatAction {
	...
	public AbstractPreference getPreferenceRules() {
		if (preferences == null) {
			preferences = new Mp3FilenameFormatterRule();
	...
	public FilenameFormatter getFormatter(File file) {
		try {
			return new Mp3Filenameformatter(file,
					(Mp3FilenameFormatterRule) getPreferenceRules());
			...
			throw new IllegalArgumentException(
					"Can't instanitate mp3 filename formatter!", e);
		}
	}
